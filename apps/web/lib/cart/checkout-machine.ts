...
const ALLOWED: Record<CheckoutKind, ReadonlyArray<CheckoutKind>> = {
  BROWSING: ['WALLET_REQUIRED', 'NETWORK_REQUIRED', 'REVALIDATING'],
  WALLET_REQUIRED: ['NETWORK_REQUIRED', 'REVALIDATING', 'BROWSING'],
  NETWORK_REQUIRED: ['REVALIDATING', 'WALLET_REQUIRED', 'BROWSING'],
  REVALIDATING: ['REVIEW', 'LISTING_GONE', 'PURCHASE_FAILED', 'NETWORK_REQUIRED', 'WALLET_REQUIRED'],
